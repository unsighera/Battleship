...
namespace Battleship
{
    public class Battleship
    {
        ...
        protected void Stroke(int[,] Field, int i, int j)
        {
            ...
            for (int k = 1; k < 4; k++)
            {
                ...
                if (Field[i - k, j] == 1) { return; }
                if (Field[i - k, j] == 0 || Field[i - k, j] == 3) { break; }
            }
            for (int k = 1; k < 4; k++)
            {
                if (Field[i + k, j] == 2) { Long++; }
                if (Field[i + k, j] == 1) { return; }
                if (Field[i + k, j] == 0 || Field[i + k, j] == 3) { break; }
    ...
    public class User : Battleship
    {
        ...
        private void S4()
        {
            ...
            {
                y = random.Next(5);
                for (int i = y; i < y + 4; i++) { UserField[i, x] = 1; }
                return;
            }
            if (y > 5)
            {
                x = random.Next(5);
                for (int j = x; j < x + 4; j++) { UserField[y, j] = 1; }
                return;
            }
            int k = random.Next(1);

            if (k == 0) { for (int i = y; i < y + 4; i++) { UserField[i, x] = 1; } }
            else
            { 
                for (int j = x; j < x + 4; j++) { UserField[y, j] = 1; }
            }
        ...
        private void S3()
        {
            ...
            if (y > 6)
            {
                ...
                for (int i = y - 1; i < y + 2; i++)
                {
                    ...
                    for (int j = x - 1; j < x + 4; j++)
                    {
                        if (j < 0) { j++; }
                        if (j > 9) { break; }
                        if (UserField[i, j] != 0) { return; }
                    }
                }
                for (int j = x; j < x + 3; j++) { UserField[y, j] = 1; }
                Number++;
                return;
            }
            if (x > 6)
            {
                ...
                for (int i = y; i < y + 3; i++) { UserField[i, x] = 1; }
                Number++;
                return;
            }
            int k = random.Next(1);
        ...
        private void S2()
        {
            ...
            if (y > 7)
            {
                ...
                for (int j = x; j < x + 2; j++) { UserField[y, j] = 1; }
                Number++;
                return;
            }
            if (x > 7)
            {
                ...
                for (int i = y; i < y + 2; i++) { UserField[i, x] = 1; }
                Number++;
                return;
            }
            int k = random.Next(1);
    ...
    public class Bot : Battleship
    {
        ...
        public bool Hit(int i, int j)
        {
            ...
            if (UserField[i, j] > 1) { return false; }
            return false;
        }
        ...
        private void S4()
        {
            ...
            {
                y = random.Next(5);
                for (int i = y; i < y + 4; i++) { BotField[i, x] = 1; }
                return;
            }
            if (y > 5)
            {
                x = random.Next(5);
                for (int j = x; j < x + 4; j++) { BotField[y, j] = 1; }
                return;
            }
            int k = random.Next(1);
            if (k == 0)
        ...
        private void S3()
        {
            ...
            if (y > 6)
            {
                ...
                for (int i = y - 1; i < y + 2; i++)
                {
                    ...
                    for (int j = x - 1; j < x + 4; j++)
                    {
                        if (j < 0) { j++; }
                        if (j > 9) { break; }
                        if (BotField[i, j] != 0) { return; }
                    }
                }
                for (int j = x; j < x + 3; j++) { BotField[y, j] = 1; }
                Number++;
                return;
            }
            if (x > 6)
            {
                ...
                for (int i = y; i < y + 3; i++) { BotField[i, x] = 1; }
                Number++;
                return;
            }
            int k = random.Next(1);
        ...
        private void S2()
        {
            ...
            if (y > 7)
            {
                ...
                for (int j = x; j < x + 2; j++) { BotField[y, j] = 1; }
                Number++;
                return;
            }
            if (x > 7)
            {
                ...
                for (int i = y; i < y + 2; i++) { BotField[i, x] = 1; }
                Number++;
                return;
            }
            int k = random.Next(1);
